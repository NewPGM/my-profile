  ...
  return (
    <html lang="th">
      ...
      <nav>
        ...
        {children}
        <footer className="bg-black bg-opacity-70 backdrop-blur-md py-10 border-t border-gray-800 mt-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-center items-center gap-12">
          ...
          {/* ส่วนขวา - Social Media */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">ติดตาม</h3>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>© {new Date().getFullYear()} Portfolio Website. สงวนลิขสิทธิ์.</p>
        </div>
      </div>
    </footer>
      </body>
